...
import { getReport, getReportDeatils } from "../../services/admin/adminReports"
                            ...
                            <div className="w-[100%] h-[350px] flex justify-center">
                                ...
                                <h1 className="font-dm text-lg text-white">Reason</h1>
                                 ...
                                 <div className="w-[100%] h-[200px] border-2 ">
                                  <textarea  placeholder="Type an Enquiry Message  And send To Provider  " className="pl-3  text-sm font-dm w-full h-full bg-banner-gray" name="" id="" />
                                 </div>
