...
function AccountSettings() {
  ...
  const [showPassword ,setShowPassword] = useState<{old:boolean,new:boolean}>({old:false,new:false})
  ...
  const OnClickChangePassword = ()=>{
    axiosInstance.patch(providerProfile.changePassword,{id:profile?.profile?._id,currentpassowrd:password,newpassowrd:newPassword}).then((response)=>{
  ...
  const OnClickUpdateData = (whichisTotChange: string, newOne: string) => {
    ...
    axiosInstance
      ...
      .then((response) => {
        ...
        setEditSelector({ ownerName: false, passowrd: false, workshopname: false, mobile: false })
      }).catch((error) => {
      ...
      <div className="w-[95%] h-[500px] bg-red-500 mt-4   flex  animate-fadeInDownBig">
        <div className="w-[30%] h-[100%] flex flex-col">
          <div className="w-[65%] h-[200px] bg-banner-gray flex items-center justify-center relative rounded-md">
            ...
            <div className="w-[40%] h-[40%] absolute -bottom-11 flex justify-end items-center left-40">
              <FaCamera className="text-4xl text-gray-100 cursor-pointer" onClick={()=>{
                console.log("clcked");
        ...
        <div className="w-[70%] h-[100%]  flex-col justify-between">
          <div className="h-[50%] w-[100%] flex justify-between ">
            <div
              className={`w-[48%] h-[90%]  flex flex-col items-center place-content-center ${editSelector.workshopname
            ...
            <div
              className={`w-[48%] h-[90%]  flex flex-col items-center place-content-center ${editSelector.ownerName
                  ? "animate-flipInX bg-banner-gray "
                  : "bg-gradient-to-b from-gray-900"
                }`}
            >
          ...
          <div className="h-[50%] w-[100%]  flex justify-between ">
            <div
              className={`w-[48%] h-[90%]   flex flex-col items-center place-content-center ${editSelector.mobile
                  ? "animate-flipInX bg-banner-gray "
                  : "bg-gradient-to-b from-gray-900"
                } `}
            >
            ...
            <div
              className={`w-[48%] h-[90%]  flex flex-col items-center place-content-center ${editSelector.passowrd
                  ? "animate-flipInX bg-banner-gray "
                  : "bg-gradient-to-b from-gray-900"
                }`}
            >
              <div className="w-[95%] h-[95%] flex flex-col space-y-2">
                {editSelector.passowrd ? (
                  <>
                    ...
                    <div className="w-[100%] h-[30%] space-y-2">
                      ...
                      <div className="relative w-[95%]  h-[50%]">
                        ...
                        <button
                          ...
                          onClick={() => setShowPassword({old:true,new:false})}
                        >
                    ...
                    <div className="w-[100%] h-[30%] space-y-2">
                      ...
                      <div className="relative w-[95%]  h-[50%]">
                        ...
                        <button
                          type="button"
                          className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-200"
                          onClick={() => setShowPassword({old:false,new:true})}
                        >
                    ...
                    <div className="w-[95%] h-[15%] space-y-2 flex justify-end">
                      <button className="h-[90%] w-[30%] bg-green-500 rounded-sm text-white" onClick={(OnClickChangePassword)}>
                        Done
                      </button>
                    </div>
                  </>
