          ...
          <div className="w-[100%] h-[400px]  flex items-end justify-center">
            <div className="w-[95%] h-[300px] flex md:flex-row flex-col md:justify-center md:space-x-24">
              <div className=" md:w-[100%] h-[170px]">
                <div className="md:mt-6   w-[100%] h-[170px]  flex animate-fadeInDownBig cursor-pointer" onClick={()=>{
                  ...
                  <div className="w-[70%] ">
                    <div className="w-[80%] h-[150px]  flex  place-items-center">
                      <h1 className="text-white text-sm md:text-md font-semibold">"Find Nearby Services Tailored to Your Vehicle – Explore Local Repair Centers and Service Providers for Cars and Bikes with Ease!"</h1>
                    </div>
                  </div>
                  <div className="w-[20%]  flex items-center ">
                    <button className="text-white text-sm bg-orange w-[100%] h-[50px] rounded-md hover:shadow-[0_10px_20px_rgba(255,_165,_0,_0.7)] transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 animate-bounce  flex pl-3 justify-center items-center text-md font-semibold ">click to view the services <FaArrowRight className="text-md text-white ml-2 mt-1" /></button>
                  </div>
                </div>
              </div>
              <div className="md:w-[40%] h-[300px] hidden ">
                <div className="md:mt-6  w-[100%]  md:h-[170px] bg-gradient-to-b from-gray-950 flex animate-fadeInDownBig cursor-pointer" onClick={()=>{
                  ...
                  <div className="w-[80%] ">
                    <div className="w-[80%] h-[150px]  flex place-content-center place-items-center">
                      <h1 className="text-white text-sm md:text-md">Roadside Assistance – Quick Help for Your Car or Bike, Anytime, Anywhere</h1>
                    </div>
                  </div>
                </div>
              </div>
